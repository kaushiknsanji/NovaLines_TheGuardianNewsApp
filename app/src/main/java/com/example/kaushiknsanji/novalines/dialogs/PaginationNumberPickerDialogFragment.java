package com.example.kaushiknsanji.novalines.dialogs;
...
public class PaginationNumberPickerDialogFragment extends DialogFragment
    ...
    public static final String PAGN_DIALOG_FRAGMENT_TAG = PaginationNumberPickerDialogFragment.class.getSimpleName();
