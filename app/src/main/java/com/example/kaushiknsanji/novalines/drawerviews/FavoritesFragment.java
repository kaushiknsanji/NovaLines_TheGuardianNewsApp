...
public class FavoritesFragment extends Fragment {
    ...
    /**
     * Constructor of {@link FavoritesFragment}
     *
     * @return Instance of this Fragment {@link FavoritesFragment}
     */
     ...
     * @return Return the View for the fragment's UI ('R.layout.favorites_layout').
     */
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        //Inflating the layout 'R.layout.favorites_layout'
    ...
    private void setupToolBar() {
        ...
        titleTextView.setText(getString(R.string.favorites_title_str));
    }
}
