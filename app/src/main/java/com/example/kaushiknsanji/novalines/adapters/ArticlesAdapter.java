...
public class ArticlesAdapter extends RecyclerView.Adapter<ArticlesAdapter.ViewHolder>
     ...
     */
    public ArticlesAdapter(@NonNull Context context, @LayoutRes int resource, @NonNull List<NewsArticleInfo> newsArticleInfos, int[] loaderIds, String newsTopicId) {
        mContext = context;
        mLayoutRes = resource;
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if (mNewsTopicId.equals(newsArticleInfo.getSectionId())) {
            //Removing the "Open News Section" Menu item for the News Items shown for the same section
            holder.popupMenu.getMenu().removeItem(R.id.jump_section_action_id);
        }
